...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [V_HASH]    = ACTION_TAP_DANCE_DOUBLE(KC_V, KC_HASH),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|---------+---------+---------+---------+---------+---------|                     |---------+---------+---------+---------+---------+---------|
      CTL_TAB,    KC_A,    KC_R,      KC_S,    KC_T,     KC_G,                           KC_M,     KC_N,     KC_E,   TD(I_EQ),   KC_O,  TD(LBR_RBR),
  //|---------+---------+---------+---------+---------+---------|                     |---------+---------+---------+---------+---------+---------|
      SFT_ESC,    KC_Z,    KC_X,      KC_C,    KC_D,   TD(V_HASH),                    TD(TD_KAT),   TD(H_DOL), TD(CMA_SCLN), KC_DOT, KC_SLSH, TD(LPAR_RPAR),
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MY_REDO, MY_CPY,  KC_P4,   KC_P5,    KC_P6, MY_UNDO,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_PMNS, KC_PPLS,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      LCT_PRN, KC_PIPE, KC_LCBR, MY_REDO, KC_RCBR, KC_PSCR,                      KC_EQL, KC_PIPE,  KC_LT,    KC_GT, KC_BSLS, RCT_PRN,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
